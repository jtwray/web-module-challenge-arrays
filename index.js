...
function is31Flavors(flavaList ) {

 return console.log (flavaList.length === 31 ? true : false);
}
console.log(31);
...
function addFlavor(originalFlavors,newFlav) {
  /*code here*/
return oF=[newFlav,...originalFlavors];


}

let answer2 = addFlavor(originalFlavors,"RainbowSherbert");
